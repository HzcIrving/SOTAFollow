...
> **图 1**（来源：π0.7 论文 Figure 1）：π0.7 整体架构图，展示 VLM Backbone + MEM History Encoder + Action Expert 的数据流，以及多模态 Context 条件化信号
...
![图 2：多模态 Context 示例](π0.7_figures/fig2_context_example.jpeg)

> **图 2**（来源：π0.7 论文 Figure 2）：多模态 Context 示例，包含 Task、Subtask Instruction、Observation、Metadata
...
### 3.6 Action Expert 架构

![图 3：Action Expert 架构](π0.7_figures/fig3_action_expert.jpeg)

> **图 3**（来源：π0.7 论文 Figure 3）：Action Expert 架构，使用 Flow Matching Transformer 输出 50 步 action chunk

### 3.7 推理流程（Algorithm 1）
...
### 3.8 Classifier-Free Guidance（CFG）
...
![图 4：灵巧操控实验结果](π0.7_figures/fig9_dexterity_results.jpeg)

> **图 4**（来源：π0.7 论文 Figure 9）：π0.7 与 π*₀.6 RL Specialist 在多种灵巧操控任务上的性能对比
...
![图 5：指令跟随实验](π0.7_figures/fig8_instruction_examples.jpeg)

> **图 5**（来源：π0.7 论文 Figure 8）：指令跟随示例，展示多步指令任务
...
![图 6：跨本体迁移实验](π0.7_figures/fig12_cross_embodiment.jpeg)

> **图 6**（来源：π0.7 论文 Figure 12）：跨本体迁移结果，π0.7 在不同机器人平台间的零样本迁移能力
...
![图 7：数据缩放规律](π0.7_figures/fig18_scaling.jpeg)

> **图 7**（来源：π0.7 论文 Figure 18）：数据规模与多样性缩放曲线，验证有/无 Metadata 情况下数据量对性能的影响
