...
#### 3.2 Subtask Instructions（子任务指令）
...
#### 3.4 Episode Metadata（Episode 元数据）
...
![图 5：灵巧操控实验结果](π0.7_figures/fig9_dexterity_results.jpeg)
...
![图 6：指令跟随实验](π0.7_figures/fig8_instruction_examples.jpeg)
